...
export function EditRidePage() {
  ...
  const isSaving = updateMutation.isPending || createGroupMutation.isPending ||
                   updateGroupMutation.isPending || deleteGroupMutation.isPending;
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="pt-4 flex items-center justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={isSaving || !title.trim() || !date || activeGroups.filter(g => g.name.trim()).length === 0}

      ...
      <div className="mb-8">
        ...
        <div className="mt-4 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600">Upcoming and past rides for {team.name}</p>
          </div>
          {canCreate && (
            <Link
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow border border-gray-200">
          ...
          <p className="mt-2 text-gray-500">
            {canCreate
              ...
              : isMember
                ? 'No rides have been scheduled yet. Check back later!'
                : isAuthenticated
                  ? 'Join this team to see and participate in rides.'
                  : 'Sign in and join this team to see rides.'}
          </p>
          {canCreate && (
            <Link
              to={`/teams/${teamSlug}/rides/new`}

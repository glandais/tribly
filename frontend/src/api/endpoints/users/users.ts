...
export type UpdateCurrentUserMutationError = ErrorType<ErrorResponse | void>

/**
 * @summary Update current user
 */
export const useUpdateCurrentUser = <TError = ErrorType<ErrorResponse | void>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof updateCurrentUser>>,
      TError,
...
export type GetCurrentUserQueryError = ErrorType<ErrorResponse | void>
 ...
 */
export const deleteCurrentUser = (options?: SecondParameter<typeof axiosMutator>) => {
  return axiosMutator<void>({ url: `/api/users/me`, method: 'DELETE' }, options)
}
 ...
 */
export const deleteAvatar = (options?: SecondParameter<typeof axiosMutator>) => {
  return axiosMutator<UserDto>({ url: `/api/users/me/avatar`, method: 'DELETE' }, options)
}
...
export const getUserById = (
  ...
  return axiosMutator<PublicUserDto>({ url: `/api/users/${id}`, method: 'GET', signal }, options)
}
...
export type GetUserByIdQueryError = ErrorType<ErrorResponse | void>

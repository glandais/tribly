...
export const useGetAuthenticationOptions = <TError = ErrorType<void>, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getGetAuthenticationOptionsMutationOptions(options)
 ...
 */
export const deletePasskey = (id: string, options?: SecondParameter<typeof axiosMutator>) => {
  return axiosMutator<void>({ url: `/api/auth/passkeys/${id}`, method: 'DELETE' }, options)
}

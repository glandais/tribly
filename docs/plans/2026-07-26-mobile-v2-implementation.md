...
| # | Tâche | Fichiers | Dépend de | Taille | Fin |
|---|---|---|---|---|---|
...
| # | Tâche | Défaut et correction | Fichiers | Dépend de | Taille | Fin |
|---|---|---|---|---|---|---|
...
une réponse qui n'arrivera pas. Les identifiants de template Brevo ne sont pas encore renseignés :
tant qu'ils manquent, l'endpoint échoue en nommant le template absent. C'est une tâche
d'exploitation, pas de code, et le mobile n'a rien à contourner — il rend le 500.

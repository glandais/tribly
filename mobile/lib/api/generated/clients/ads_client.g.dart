...
class _AdsClient implements AdsClient {
  _AdsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdListResponse> listAds({
    ...
    final _options = _setStreamType<AdListResponse>(
    ...
    late AdListResponse _value;
    try {
      _value = AdListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<AdDto> getAd({required String slug, required String teamSlug}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<void> contactAdAuthor({
    required String slug,
    required String teamSlug,
    required AdContactRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<void>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/teams/${teamSlug}/classifieds/${slug}/contact',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<AdEditDto> getAdEdit({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdEditDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AdEditDto _value;
    try {
      _value = AdEditDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }

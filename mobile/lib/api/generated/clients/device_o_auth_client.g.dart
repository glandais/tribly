...
part of 'device_o_auth_client.dart';
...
class _DeviceOAuthClient implements DeviceOAuthClient {
  _DeviceOAuthClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<void> deviceComplete({required CompleteRequest body}) async {
  ...
  @override
  Future<DeviceCodeResponse> device({required DeviceRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};

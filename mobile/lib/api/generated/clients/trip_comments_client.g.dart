...
part of 'trip_comments_client.dart';
...
class _TripCommentsClient implements TripCommentsClient {
  _TripCommentsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<void> deleteTripComment({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/teams/${teamSlug}/trips/${entitySlug}/comments/${commentId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),

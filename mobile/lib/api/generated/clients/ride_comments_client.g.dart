...
part of 'ride_comments_client.dart';
...
class _RideCommentsClient implements RideCommentsClient {
  _RideCommentsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<void> deleteRideComment({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/teams/${teamSlug}/rides/${entitySlug}/comments/${commentId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),

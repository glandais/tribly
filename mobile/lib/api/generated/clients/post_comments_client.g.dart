...
part of 'post_comments_client.dart';
...
class _PostCommentsClient implements PostCommentsClient {
  _PostCommentsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<void> deletePostComment({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/teams/${teamSlug}/posts/${entitySlug}/comments/${commentId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),

...
part of 'route_comments_client.dart';
...
class _RouteCommentsClient implements RouteCommentsClient {
  _RouteCommentsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<void> deleteRouteComment({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/teams/${teamSlug}/routes/${entitySlug}/comments/${commentId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),

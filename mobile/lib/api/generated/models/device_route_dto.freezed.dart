...
$DeviceRouteDtoCopyWith<DeviceRouteDto> get copyWith => _$DeviceRouteDtoCopyWithImpl<DeviceRouteDto>(this as DeviceRouteDto, _$identity);

  /// Serializes this DeviceRouteDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  final _this = this as DeviceRouteDto;
...
int get hashCode {
  final _this = this as DeviceRouteDto;
  return Object.hash(runtimeType,_this.teamSlug,_this.routeSlug,_this.routeName,_this.distance,_this.elevationGain,_this.startLat,_this.startLon);
}

@override
String toString() {
  final _this = this as DeviceRouteDto;
  return 'DeviceRouteDto(teamSlug: ${_this.teamSlug}, routeSlug: ${_this.routeSlug}, routeName: ${_this.routeName}, distance: ${_this.distance}, elevationGain: ${_this.elevationGain}, startLat: ${_this.startLat}, startLon: ${_this.startLon})';
}
...
/// @nodoc
abstract mixin class $DeviceRouteDtoCopyWith<$Res>  {
...
/// @nodoc
class _$DeviceRouteDtoCopyWithImpl<$Res>
    implements $DeviceRouteDtoCopyWith<$Res> {
  _$DeviceRouteDtoCopyWithImpl(this._self, this._then);

  final DeviceRouteDto _self;
  final $Res Function(DeviceRouteDto) _then;
...
/// Adds pattern-matching-related methods to [DeviceRouteDto].
extension DeviceRouteDtoPatterns on DeviceRouteDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DeviceRouteDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DeviceRouteDto value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DeviceRouteDto value)?  $default,){
final _that = this;
switch (_that) {
case _DeviceRouteDto() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$DeviceRouteDtoCopyWith<_DeviceRouteDto> get copyWith => __$DeviceRouteDtoCopyWithImpl<_DeviceRouteDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$DeviceRouteDtoToJson(this, );
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,teamSlug,routeSlug,routeName,distance,elevationGain,startLat,startLon);
}
...
/// @nodoc
abstract mixin class _$DeviceRouteDtoCopyWith<$Res> implements $DeviceRouteDtoCopyWith<$Res> {
...
/// @nodoc
class __$DeviceRouteDtoCopyWithImpl<$Res>
    implements _$DeviceRouteDtoCopyWith<$Res> {
  __$DeviceRouteDtoCopyWithImpl(this._self, this._then);

  final _DeviceRouteDto _self;
  final $Res Function(_DeviceRouteDto) _then;

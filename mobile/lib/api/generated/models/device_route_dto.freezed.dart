...
/// Team slug
 ...
 double get elevationGain;/// Label (e.g., 'Rapides - 18/01 09:00')
...
@override
String toString() {
  return 'DeviceRouteDto(teamSlug: $teamSlug, routeSlug: $routeSlug, name: $name, distance: $distance, elevationGain: $elevationGain, label: $label, rideDateTime: $rideDateTime, startLat: $startLat, startLon: $startLon)';
}
...
class _DeviceRouteDto implements DeviceRouteDto {
  const _DeviceRouteDto({required this.teamSlug, required this.routeSlug, required this.name, required this.distance, required this.elevationGain, this.label, this.rideDateTime, this.startLat, this.startLon});

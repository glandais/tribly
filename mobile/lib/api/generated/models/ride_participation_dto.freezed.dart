...
bool operator ==(Object other) {
  final _this = this as RideParticipationDto;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RideParticipationDto&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.userId, _this.userId) || other.userId == _this.userId)&&(identical(other.registeredAt, _this.registeredAt) || other.registeredAt == _this.registeredAt));
}
...
String toString() {
  final _this = this as RideParticipationDto;
  return 'RideParticipationDto(id: ${_this.id}, userId: ${_this.userId}, registeredAt: ${_this.registeredAt})';
}

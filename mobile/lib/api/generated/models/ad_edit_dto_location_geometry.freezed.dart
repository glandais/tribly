...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdEditDtoLocationGeometry&&(identical(other.type, type) || other.type == type)&&const DeepCollectionEquality().equals(other.coordinates, coordinates));
}
...
class _AdEditDtoLocationGeometry implements AdEditDtoLocationGeometry {
  const _AdEditDtoLocationGeometry({required this.type, required final  List<double> coordinates}): _coordinates = coordinates;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdEditDtoLocationGeometry&&(identical(other.type, type) || other.type == type)&&const DeepCollectionEquality().equals(other._coordinates, _coordinates));
}

...
/// Error code
 String get code;/// Additional details
...
@useResult
$Res call({
 String code, ErrorDetails? errorDetails
});


$ErrorDetailsCopyWith<$Res>? get errorDetails;
...
/// Create a copy of ErrorResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? errorDetails = freezed,}) {
...
$ErrorDetailsCopyWith<$Res>? get errorDetails {
  ...
  return $ErrorDetailsCopyWith<$Res>(_self.errorDetails!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  ErrorDetails? errorDetails)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ErrorResponse() when $default != null:
return $default(_that.code,_that.errorDetails);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  ErrorDetails? errorDetails)  $default,) {final _that = this;
switch (_that) {
case _ErrorResponse():
return $default(_that.code,_that.errorDetails);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  ErrorDetails? errorDetails)?  $default,) {final _that = this;
switch (_that) {
case _ErrorResponse() when $default != null:
return $default(_that.code,_that.errorDetails);case _:
  return null;
...
class _ErrorResponse implements ErrorResponse {
  const _ErrorResponse({required this.code, this.errorDetails});
  factory _ErrorResponse.fromJson(Map<String, dynamic> json) => _$ErrorResponseFromJson(json);

/// Error code
@override final  String code;
/// Additional details
@override final  ErrorDetails? errorDetails;
...
@override $ErrorDetailsCopyWith<$Res>? get errorDetails;
...
/// Create a copy of ErrorResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? errorDetails = freezed,}) {

...
bool operator ==(Object other) {
  final _this = this as GpxPreviewListResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GpxPreviewListResponse&&const DeepCollectionEquality().equals(other.previews, _this.previews)&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.page, _this.page) || other.page == _this.page)&&(identical(other.size, _this.size) || other.size == _this.size));
}
...
int get hashCode {
  final _this = this as GpxPreviewListResponse;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.previews),_this.total,_this.page,_this.size);
}

@override
String toString() {
  final _this = this as GpxPreviewListResponse;
  return 'GpxPreviewListResponse(previews: ${_this.previews}, total: ${_this.total}, page: ${_this.page}, size: ${_this.size})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? previews = null,Object? total = null,Object? page = null,Object? size = null,}) {
  return _then(GpxPreviewListResponse(
...
class _GpxPreviewListResponse implements GpxPreviewListResponse {
  const _GpxPreviewListResponse({required  List<GpxPreviewSummaryDto> previews, required this.total, required this.page, required this.size}): _previews = previews;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _GpxPreviewListResponse&&const DeepCollectionEquality().equals(other.previews, _previews)&&(identical(other.total, total) || other.total == total)&&(identical(other.page, page) || other.page == page)&&(identical(other.size, size) || other.size == size));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_previews),total,page,size);
}

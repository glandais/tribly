...
/// Whether the deletion is refused (SOLE_TEAM_ADMIN): the user is the only admin of at least one team that has other members
 bool get blocked;/// Teams the user is the only admin of while other members remain; they must name another admin, or delete the team, before deleting their account
 List<TeamPublicationDto> get blockingTeams;/// Teams the user administers and is the only member of; they are deleted with the account
 List<TeamPublicationDto> get deletedTeams;
...
int get hashCode {
  final _this = this as AccountDeletionImpactDto;
  return Object.hash(runtimeType,_this.blocked,const DeepCollectionEquality().hash(_this.blockingTeams),const DeepCollectionEquality().hash(_this.deletedTeams));
}

@override
String toString() {
  final _this = this as AccountDeletionImpactDto;
  return 'AccountDeletionImpactDto(blocked: ${_this.blocked}, blockingTeams: ${_this.blockingTeams}, deletedTeams: ${_this.deletedTeams})';
}
...
@useResult
$Res call({
 bool blocked, List<TeamPublicationDto> blockingTeams, List<TeamPublicationDto> deletedTeams
});
...
/// Create a copy of AccountDeletionImpactDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? blocked = null,Object? blockingTeams = null,Object? deletedTeams = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool blocked,  List<TeamPublicationDto> blockingTeams,  List<TeamPublicationDto> deletedTeams)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountDeletionImpactDto() when $default != null:
return $default(_that.blocked,_that.blockingTeams,_that.deletedTeams);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool blocked,  List<TeamPublicationDto> blockingTeams,  List<TeamPublicationDto> deletedTeams)  $default,) {final _that = this;
switch (_that) {
case _AccountDeletionImpactDto():
return $default(_that.blocked,_that.blockingTeams,_that.deletedTeams);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool blocked,  List<TeamPublicationDto> blockingTeams,  List<TeamPublicationDto> deletedTeams)?  $default,) {final _that = this;
switch (_that) {
case _AccountDeletionImpactDto() when $default != null:
return $default(_that.blocked,_that.blockingTeams,_that.deletedTeams);case _:
  return null;
...
class _AccountDeletionImpactDto implements AccountDeletionImpactDto {
  const _AccountDeletionImpactDto({required this.blocked, required  List<TeamPublicationDto> blockingTeams, required  List<TeamPublicationDto> deletedTeams}): _blockingTeams = blockingTeams,_deletedTeams = deletedTeams;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _AccountDeletionImpactDto&&(identical(other.blocked, blocked) || other.blocked == blocked)&&const DeepCollectionEquality().equals(other.blockingTeams, _blockingTeams)&&const DeepCollectionEquality().equals(other.deletedTeams, _deletedTeams));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,blocked,const DeepCollectionEquality().hash(_blockingTeams),const DeepCollectionEquality().hash(_deletedTeams));
}

@override
String toString() {
    return 'AccountDeletionImpactDto(blocked: $blocked, blockingTeams: $blockingTeams, deletedTeams: $deletedTeams)';
}
...
/// Create a copy of AccountDeletionImpactDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? blocked = null,Object? blockingTeams = null,Object? deletedTeams = null,}) {

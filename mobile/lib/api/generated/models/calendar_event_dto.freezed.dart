...
int get hashCode {
  final _this = this as CalendarEventDto;
  return Object.hashAll([runtimeType,_this.id,_this.title,_this.start,_this.allDay,_this.type,_this.teamSlug,_this.teamName,_this.entitySlug,_this.registered,_this.status,_this.end,_this.tripSlug,_this.startPlaceName,_this.distance,_this.elevationGain,_this.thumbnailUrl,_this.thumbnailLightUrl,_this.thumbnailDarkUrl,_this.groupName]);
}

@override
String toString() {
  final _this = this as CalendarEventDto;
  return 'CalendarEventDto(id: ${_this.id}, title: ${_this.title}, start: ${_this.start}, allDay: ${_this.allDay}, type: ${_this.type}, teamSlug: ${_this.teamSlug}, teamName: ${_this.teamName}, entitySlug: ${_this.entitySlug}, registered: ${_this.registered}, status: ${_this.status}, end: ${_this.end}, tripSlug: ${_this.tripSlug}, startPlaceName: ${_this.startPlaceName}, distance: ${_this.distance}, elevationGain: ${_this.elevationGain}, thumbnailUrl: ${_this.thumbnailUrl}, thumbnailLightUrl: ${_this.thumbnailLightUrl}, thumbnailDarkUrl: ${_this.thumbnailDarkUrl}, groupName: ${_this.groupName})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,title,start,allDay,type,teamSlug,teamName,entitySlug,registered,status,end,tripSlug,startPlaceName,distance,elevationGain,thumbnailUrl,thumbnailLightUrl,thumbnailDarkUrl,groupName]);
}

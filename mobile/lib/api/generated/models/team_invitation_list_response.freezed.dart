...
class _TeamInvitationListResponse implements TeamInvitationListResponse {
  const _TeamInvitationListResponse({required final  List<TeamInvitationDto> invitations, required this.total, required this.page, required this.size}): _invitations = invitations;

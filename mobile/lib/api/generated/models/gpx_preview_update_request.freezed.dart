...
bool operator ==(Object other) {
  final _this = this as GpxPreviewUpdateRequest;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GpxPreviewUpdateRequest&&(identical(other.name, _this.name) || other.name == _this.name)&&const DeepCollectionEquality().equals(other.points, _this.points));
}
...
String toString() {
  final _this = this as GpxPreviewUpdateRequest;
  return 'GpxPreviewUpdateRequest(name: ${_this.name}, points: ${_this.points})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? points = freezed,}) {
  return _then(GpxPreviewUpdateRequest(
...
class _GpxPreviewUpdateRequest implements GpxPreviewUpdateRequest {
  const _GpxPreviewUpdateRequest({required this.name,  List<GeoPoint>? points}): _points = points;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _GpxPreviewUpdateRequest&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.points, _points));
}

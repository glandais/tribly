...
@override
int get hashCode {
    return Object.hashAll([runtimeType,team,id,slug,name,media,dateTime,status,visibility,participantCount,groupCount,const DeepCollectionEquality().hash(_groups),const DeepCollectionEquality().hash(_topParticipants),deleted,registered,full,excerpt,publishAt,createdAt,routeSlug,startPlace,endPlace,thumbnailLightUrl,thumbnailDarkUrl,thumbnailUrl,registeredGroupId,commentCount]);
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,team,id,slug,name,media,dateTime,status,visibility,deleted,excerpt,thumbnailUrl,publishAt,createdAt,commentCount);
}

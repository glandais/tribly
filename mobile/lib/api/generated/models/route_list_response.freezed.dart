...
bool operator ==(Object other) {
  final _this = this as RouteListResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RouteListResponse&&const DeepCollectionEquality().equals(other.routes, _this.routes)&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.page, _this.page) || other.page == _this.page)&&(identical(other.size, _this.size) || other.size == _this.size));
}
...
int get hashCode {
  final _this = this as RouteListResponse;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.routes),_this.total,_this.page,_this.size);
}

@override
String toString() {
  final _this = this as RouteListResponse;
  return 'RouteListResponse(routes: ${_this.routes}, total: ${_this.total}, page: ${_this.page}, size: ${_this.size})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? routes = null,Object? total = null,Object? page = null,Object? size = null,}) {
  return _then(RouteListResponse(
...
class _RouteListResponse implements RouteListResponse {
  const _RouteListResponse({required  List<RouteDto> routes, required this.total, required this.page, required this.size}): _routes = routes;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _RouteListResponse&&const DeepCollectionEquality().equals(other.routes, _routes)&&(identical(other.total, total) || other.total == total)&&(identical(other.page, page) || other.page == page)&&(identical(other.size, size) || other.size == size));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_routes),total,page,size);
}

...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,team,id,slug,name,media,status,visibility,adType,createdAt,updatedAt,createdById,deleted,price,rentalPeriod,locationDescription);

@override
String toString() {
  return 'AdDto(team: $team, id: $id, slug: $slug, name: $name, media: $media, status: $status, visibility: $visibility, adType: $adType, createdAt: $createdAt, updatedAt: $updatedAt, createdById: $createdById, deleted: $deleted, price: $price, rentalPeriod: $rentalPeriod, locationDescription: $locationDescription)';
}
...
@useResult
$Res call({
 TeamPublicationDto team, String id, String slug, String name, MediaDto media, String status, String visibility, String adType, String createdAt, String updatedAt, String createdById, bool deleted, num? price, String? rentalPeriod, String? locationDescription
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TeamPublicationDto team,  String id,  String slug,  String name,  MediaDto media,  String status,  String visibility,  String adType,  String createdAt,  String updatedAt,  String createdById,  bool deleted,  num? price,  String? rentalPeriod,  String? locationDescription)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdDto() when $default != null:
return $default(_that.team,_that.id,_that.slug,_that.name,_that.media,_that.status,_that.visibility,_that.adType,_that.createdAt,_that.updatedAt,_that.createdById,_that.deleted,_that.price,_that.rentalPeriod,_that.locationDescription);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TeamPublicationDto team,  String id,  String slug,  String name,  MediaDto media,  String status,  String visibility,  String adType,  String createdAt,  String updatedAt,  String createdById,  bool deleted,  num? price,  String? rentalPeriod,  String? locationDescription)  $default,) {final _that = this;
switch (_that) {
case _AdDto():
return $default(_that.team,_that.id,_that.slug,_that.name,_that.media,_that.status,_that.visibility,_that.adType,_that.createdAt,_that.updatedAt,_that.createdById,_that.deleted,_that.price,_that.rentalPeriod,_that.locationDescription);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TeamPublicationDto team,  String id,  String slug,  String name,  MediaDto media,  String status,  String visibility,  String adType,  String createdAt,  String updatedAt,  String createdById,  bool deleted,  num? price,  String? rentalPeriod,  String? locationDescription)?  $default,) {final _that = this;
switch (_that) {
case _AdDto() when $default != null:
return $default(_that.team,_that.id,_that.slug,_that.name,_that.media,_that.status,_that.visibility,_that.adType,_that.createdAt,_that.updatedAt,_that.createdById,_that.deleted,_that.price,_that.rentalPeriod,_that.locationDescription);case _:
  return null;
...
class _AdDto implements AdDto {
  const _AdDto({required this.team, required this.id, required this.slug, required this.name, required this.media, required this.status, required this.visibility, required this.adType, required this.createdAt, required this.updatedAt, required this.createdById, required this.deleted, this.price, this.rentalPeriod, this.locationDescription});

...
class _AssetsDto implements AssetsDto {
  const _AssetsDto({required  List<AssetDto> images, required  List<AssetDto> attachments, this.logo, this.originalGpx, this.gpx, this.fit, this.thumbnailLight, this.thumbnailDark}): _images = images,_attachments = attachments;

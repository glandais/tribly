...
bool operator ==(Object other) {
  final _this = this as TeamListResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TeamListResponse&&const DeepCollectionEquality().equals(other.teams, _this.teams)&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.page, _this.page) || other.page == _this.page)&&(identical(other.size, _this.size) || other.size == _this.size));
}
...
String toString() {
  final _this = this as TeamListResponse;
  return 'TeamListResponse(teams: ${_this.teams}, total: ${_this.total}, page: ${_this.page}, size: ${_this.size})';
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _TeamListResponse&&const DeepCollectionEquality().equals(other.teams, _teams)&&(identical(other.total, total) || other.total == total)&&(identical(other.page, page) || other.page == page)&&(identical(other.size, size) || other.size == size));
}

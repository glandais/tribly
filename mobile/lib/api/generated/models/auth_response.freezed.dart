...
@useResult
$Res call({
 String? accessToken, int? expiresIn, UserDto? user, String? refreshToken
});
...
/// Create a copy of AuthResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = freezed,Object? expiresIn = freezed,Object? user = freezed,Object? refreshToken = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? accessToken,  int? expiresIn,  UserDto? user,  String? refreshToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
return $default(_that.accessToken,_that.expiresIn,_that.user,_that.refreshToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? accessToken,  int? expiresIn,  UserDto? user,  String? refreshToken)  $default,) {final _that = this;
switch (_that) {
case _AuthResponse():
return $default(_that.accessToken,_that.expiresIn,_that.user,_that.refreshToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? accessToken,  int? expiresIn,  UserDto? user,  String? refreshToken)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
return $default(_that.accessToken,_that.expiresIn,_that.user,_that.refreshToken);case _:
  return null;
...
class _AuthResponse implements AuthResponse {
  const _AuthResponse({this.accessToken, this.expiresIn, this.user, this.refreshToken});
...
/// Create a copy of AuthResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = freezed,Object? expiresIn = freezed,Object? user = freezed,Object? refreshToken = freezed,}) {

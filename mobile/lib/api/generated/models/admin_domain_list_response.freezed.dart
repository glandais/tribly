...
bool operator ==(Object other) {
  final _this = this as AdminDomainListResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminDomainListResponse&&const DeepCollectionEquality().equals(other.domains, _this.domains)&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.page, _this.page) || other.page == _this.page)&&(identical(other.size, _this.size) || other.size == _this.size));
}
...
int get hashCode {
  final _this = this as AdminDomainListResponse;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.domains),_this.total,_this.page,_this.size);
}

@override
String toString() {
  final _this = this as AdminDomainListResponse;
  return 'AdminDomainListResponse(domains: ${_this.domains}, total: ${_this.total}, page: ${_this.page}, size: ${_this.size})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? domains = null,Object? total = null,Object? page = null,Object? size = null,}) {
  return _then(AdminDomainListResponse(
...
class _AdminDomainListResponse implements AdminDomainListResponse {
  const _AdminDomainListResponse({required  List<AdminDomainDto> domains, required this.total, required this.page, required this.size}): _domains = domains;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminDomainListResponse&&const DeepCollectionEquality().equals(other.domains, _domains)&&(identical(other.total, total) || other.total == total)&&(identical(other.page, page) || other.page == page)&&(identical(other.size, size) || other.size == size));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_domains),total,page,size);
}

...
public class DeviceJwtService {
  ...
  @ConfigProperty(name = "tribly.device.jwt.access-token-expiry-minutes", defaultValue = "60")
  int accessTokenExpiryMinutes;

  @ConfigProperty(name = "tribly.device.jwt.refresh-token-expiry-days", defaultValue = "90")

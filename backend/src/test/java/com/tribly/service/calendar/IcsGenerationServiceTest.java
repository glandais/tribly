...
class IcsGenerationServiceTest {
  ...
  void generateIcs_shouldReturnValidIcsFormat() {
    ...
    assertTrue(ics.contains("PRODID:-//Tribly//Calendar//EN"));
  ...
  void generateIcs_shouldIncludeEventDetails() {
    ...
    assertTrue(ics.contains("UID:event123@tribly.app"));
  ...
  void generateIcs_shouldHandleMultipleEvents() {
    ...
    assertTrue(ics.contains("UID:event1@tribly.app"));
    assertTrue(ics.contains("UID:event2@tribly.app"));
  }

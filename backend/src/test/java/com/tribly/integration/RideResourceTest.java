...
class RideResourceTest {
  ...
  void createRide_asAdmin_shouldSucceed() {
    ...
    given()
        ...
        .contentType("application/json")
        .body(
            "{\"title\": \"Sunday Morning Ride\", \"date\": \"2025-01-20\", \"groups\": [{\"name\":"
                + " \"G1\"}]}")
        .when()
  ...
  void getRide_shouldReturnRideDetails() {
    ...
    String rideSlug =
        given()
            ...
            .contentType("application/json")
            .body(
                "{\"title\": \"Get Test Ride\", \"date\": \"2025-01-22\", \"groups\": [{\"name\":"
                    + " \"G1\"}]}")
            .when()
            .post("/api/teams/" + teamSlug + "/rides")
            .then()
  ...
  void joinRide_shouldAddParticipant() {
    ...
    String rideSlug =
        given()
            ...
            .contentType("application/json")
            .body(
                "{\"title\": \"Join Test Ride\", \"date\": \"2025-01-27\", \"groups\": [{\"name\":"
                    + " \"G1\"}]}")
            .when()
            .post("/api/teams/" + teamSlug + "/rides")
            .then()
  ...
  void joinRide_whenNotPublished_shouldBeDenied() {
    ...
    String rideSlug =
        given()
            ...
            .contentType("application/json")
            .body(
                "{\"title\": \"Draft Ride\", \"date\": \"2025-01-28\", \"groups\": [{\"name\":"
                    + " \"G1\"}]}")
            .when()
            .post("/api/teams/" + teamSlug + "/rides")
            .then()
  ...
  void leaveRide_shouldRemoveParticipant() {
    ...
    String rideSlug =
        given()
            ...
            .contentType("application/json")
            .body(
                "{\"title\": \"Leave Test Ride\", \"date\": \"2025-01-29\", \"groups\": [{\"name\":"
                    + " \"G1\"}]}")
            .when()
            .post("/api/teams/" + teamSlug + "/rides")
            .then()

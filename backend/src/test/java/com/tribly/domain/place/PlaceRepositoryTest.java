...
class PlaceRepositoryTest {
  ...
  class FindByTeam {
    ...
    void findByTeam_shouldReturnAllPlacesForTeam() {
      ...
      TriblyPage<Place> result = placeRepository.findByTeam(team.getId(), 0, 10);
    ...
    void findByTeam_shouldReturnEmptyForTeamWithNoPlaces() {
      ...
      TriblyPage<Place> result = placeRepository.findByTeam(emptyTeam.getId(), 0, 10);
    ...
    void findByTeam_shouldSupportPaginationSize() {
      ...
      TriblyPage<Place> result = placeRepository.findByTeam(team.getId(), 0, 3);
    ...
    void findByTeam_shouldSupportPaginationOffset() {
      ...
      TriblyPage<Place> page0 = placeRepository.findByTeam(team.getId(), 0, 3);
      TriblyPage<Place> page1 = placeRepository.findByTeam(team.getId(), 1, 3);
      TriblyPage<Place> page2 = placeRepository.findByTeam(team.getId(), 2, 3);
    ...
    void findByTeam_shouldReturnEmptyPageWhenBeyondResults() {
      ...
      TriblyPage<Place> result = placeRepository.findByTeam(team.getId(), 10, 5);

...
class AllPublicationRepositoryTest extends AbstractBaseTest {
  ...
  class EntityTypeMethods {
    ...
    void getEntityType_shouldReturnPublication() {
      assertEquals(
          fr.pedalons.enums.TeamEntityType.PUBLICATION, publicationRepository.getEntityType());
    }
    ...
    void getAllEntityType_shouldReturnPublication() {
      assertEquals(
          fr.pedalons.enums.EntityType.PUBLICATION, publicationRepository.getAllEntityType());
    }
  }
  ...
  class Find {
    ...
    void find_shouldReturnRides() {
      ...
      PedalonsPage<Publication> result = publicationRepository.find(query);

 ...
 */
@QuarkusTest
class TripRepositoryTest extends AbstractBaseTest {
  ...
  class EntityTypeMethods {
    ...
    void getEntityType_shouldReturnTrip() {
      assertEquals(fr.pedalons.enums.TeamEntityType.TRIP, tripRepository.getEntityType());
    }

    @Test
    @DisplayName("getAllEntityType should return TRIP")
    void getAllEntityType_shouldReturnTrip() {
      assertEquals(fr.pedalons.enums.EntityType.TRIP, tripRepository.getAllEntityType());
    }
  }
}

...
@QuarkusTest
class RideTemplateRepositoryTest extends AbstractBaseTest {
  ...
  class FindByTeam {
    ...
    void findByTeam_shouldReturnAllTemplatesForTeam() {
      ...
      PedalonsPage<RideTemplate> result = templateRepository.findByTeam(team.getId(), null, 0, 10);
    ...
    void findByTeam_shouldReturnEmptyForTeamWithNoTemplates() {
      ...
      PedalonsPage<RideTemplate> result =
    ...
    void findByTeam_shouldSupportPaginationSize() {
      ...
      PedalonsPage<RideTemplate> result = templateRepository.findByTeam(team.getId(), null, 0, 3);
    ...
    void findByTeam_shouldSupportPaginationOffset() {
      ...
      PedalonsPage<RideTemplate> page0 = templateRepository.findByTeam(team.getId(), null, 0, 3);
      PedalonsPage<RideTemplate> page1 = templateRepository.findByTeam(team.getId(), null, 1, 3);
      PedalonsPage<RideTemplate> page2 = templateRepository.findByTeam(team.getId(), null, 2, 3);
    ...
    void findByTeam_shouldReturnEmptyPageWhenBeyondResults() {
      ...
      PedalonsPage<RideTemplate> result = templateRepository.findByTeam(team.getId(), null, 10, 5);
    ...
    void findByTeam_shouldFilterBySearchTerm() {
      ...
      PedalonsPage<RideTemplate> result =
          templateRepository.findByTeam(team.getId(), "ride", 0, 10);
